...
### This is homework is to practice using for loop, while loop and low level modifications
...
bmi <- read.csv("/Users/mrnobody/Documents/NTU Third Semester/Computing in Epidemiology and Biostatistics/Data/BMIrepeated.csv")
quartz()
x <- seq(0,9,3)
